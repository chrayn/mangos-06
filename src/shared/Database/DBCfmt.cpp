...
const char ChrRacesEntryfmt[]="nxixiixxixxxxxixisxxxxxxxxxxx";
...
const char MapEntryfmt[]="nsixxxxxxxxxixxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
...
const char SpellItemEnchantmentfmt[]="niiiiiiixxiiisxxxxxxxxxx";
